...
import { ShoppingBag, Phone, MessageCircle, X, CheckCircle } from 'lucide-react';
              ...
              <form onSubmit={handleOrderSubmit} className="space-y-4 mt-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#8B0000] transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="2"
                    className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#8B0000] transition-colors resize-none"
